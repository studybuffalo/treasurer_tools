...
urlpatterns = [
    ...
    url(r"^banking/", include("bank_transactions.urls", namespace="bank_transactions")),
    url(r"^banking/reconciliation/", include("bank_reconciliation.urls", namespace="bank_reconciliation")),
    url(r"^settings/banking/", include("bank_institutions.urls", namespace="bank_institutions")),
